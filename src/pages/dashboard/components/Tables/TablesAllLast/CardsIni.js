...
function CardsLast() {
  ...
  var columns = [
    ...
    {title: "Data", field: "i2_date_auto",type: "date", render: rowData => moment(rowData.i2_date_auto).format('DD/MM/YYYY')},
  ...
  useEffect(() => { 
    axiosInstance.get('carddataall/' + columns[11]['field'])
        .then(res => {               
            setData(res.data)
