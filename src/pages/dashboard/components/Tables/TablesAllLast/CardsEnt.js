...
function CardsLast() {
  ...
  var columns = [
    ...
    {title: "Item2_Data_Auto", field: "i1_date_auto",hidden:true},
    ...
    {title: "Equipe", field: "equipe", lookup: ordered,hidden:true},
  ...
  useEffect(() => { 
    axiosInstance.get('carddataall/' + columns[21]['field'])
        .then(res => {               
            setData(res.data)
