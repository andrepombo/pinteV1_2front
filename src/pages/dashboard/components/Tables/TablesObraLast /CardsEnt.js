...
function CardsLast() {
  ...
  var columns = [
    ...
    {title: "Item1_Data_Auto", field: "i1_date_auto",hidden:true},
    ...
    {title: "Data", field: "i4_date_auto",type: "date", render: rowData => moment(rowData.i4_date_auto).format('DD/MM/YYYY')},
  ...
  useEffect(() => { 
    axiosInstance.get('carddataobra/' + id + "/" + columns[21]['field']) 
        .then(res => {               
            setData(res.data)
  ...
  return (
    <div className="App">
      <Grid container spacing={1}>
          ...
          <Grid item xs={12}>
            <MaterialTable
              //title= {'Últimos 5 ' + columns[21]["title"] + 's'}
              title= {'Últimos 5 Entregues'}
              ...
              options={{
                ...
                //filtering: true, 
                paging: false, pageSizeOptions: [5, 8, 10, 15, 25, 50, 100], pageSize: 5,
